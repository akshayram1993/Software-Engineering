...
/* Generated By:JavaCC: Do not edit this line. our_example_6.java */
/** Simple brace matcher. */
public class our_example_6 implements our_example_6Constants {
...
/** Root production. */
  ...
  static public our_example_6TokenManager token_source;
  ...
  public our_example_6(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public our_example_6(java.io.InputStream stream, String encoding) {
    ...
    token_source = new our_example_6TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  }
  ...
  /** Constructor. */
  public our_example_6(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public our_example_6(our_example_6TokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(our_example_6TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
